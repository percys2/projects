...
export const usePosStore = create((set, get) => ({
  ...
  addToCart: (product) =>
    set((state) => {
      // Support both id and product_id (current_stock uses product_id)
      ...
      // Normalize to always have an id field for consistency
      return { cart: [...state.cart, { ...product, id: productId, qty: 1, availableStock }] };
    }),
