...
"[project]/Desktop/proyectos coding/agro-erp-production-2/app/api/kardex/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!orgSlug) return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Missing org slug"
        });
        // Get org_id
        const { data: org } = await supabase.from("organizations").select("id").eq("slug", orgSlug).single();
        if (!org) return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Org not found"
        });
        let query = supabase.from("kardex_view").select("*").eq("org_id", org.id).range(offset, offset + limit - 1).order("created_at", {
            ascending: false
        });
        ...
        // Search text
        if (search) {
            query = query.or(`product_name.ilike.%${search}%,reference.ilike.%${search}%,user_email.ilike.%${search}%`);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd545798._.js.map