...
"[project]/Desktop/proyectos coding/agro-erp-production-2/app/api/inventory/stock/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const { data: stock, error } = await supabase.from("current_stock").select("*").eq("org_id", org.id).order("name"); // ← CORREGIDO
        if (error) throw error;
        // get branches
        const { data: branches } = await supabase.from("branches").select("*").eq("org_id", org.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            stock,
            branches
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0264bffd._.js.map