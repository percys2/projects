...
"[project]/Desktop/proyectos coding/agro-erp-production-2/app/api/clients/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const { data: clients, error } = await supabase.from("clients").select("*").eq("org_id", org.id).order("first_name", {
            ascending: true
        });
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(clients || []);
    } catch (err) {
...
async function POST(req) {
    try {
        ...
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(client);
    } catch (err) {
...
async function PUT(req) {
    try {
        ...
        const { data: client, error } = await supabase.from("clients").update(updateData).eq("id", body.id).eq("org_id", org.id).select().single();
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(client);
    } catch (err) {
...
async function DELETE(req) {
    try {
        ...
        const { error } = await supabase.from("clients").delete().eq("id", body.id).eq("org_id", org.id);
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$proyectos__coding$2f$agro$2d$erp$2d$production$2d$2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__171d7de7._.js.map