...
export async function POST(req) {
  try {
    ...
    const employeeData = {
      ...
      cedula: validation.data.cedula || null,
      inss_number: validation.data.inss_number || null,
      position: validation.data.position || null,
      department: validation.data.department || null,
      salary: validation.data.salary || 0,
      commissions: validation.data.commissions || 0,
      hire_date: validation.data.hire_date || null,
      contract_type: validation.data.contract_type || null,
      status: validation.data.status || "activo",
      address: validation.data.address || null,
      emergency_contact: validation.data.emergency_contact || null,
      emergency_phone: validation.data.emergency_phone || null,
      bank_account: validation.data.bank_account || null,
